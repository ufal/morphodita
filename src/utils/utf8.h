...
class utf8 {
 public:
  ...
  static bool valid(const char* str, int len);
  static inline bool valid(const std::string& str);
  static inline char32_t decode(const char*& str);
  static inline char32_t decode(const char*& str, int& len);
  static inline char32_t first(const char* str);
  static inline char32_t first(const char* str, int len);
  ...
  static void uppercase(const char* str, int len, std::string& out);
  ...
  static void lowercase(const char* str, int len, std::string& out);
...
char32_t utf8::decode(const char*& str, int& len) {
  const unsigned char*& ptr = (const unsigned char*&) str;
...
char32_t utf8::first(const char* str, int len) {
...
class utf8::buffer_decoder_helper::iterator : public std::iterator<std::input_iterator_tag, char32_t> {
 public:
  iterator(const char* str, int len) : codepoint(0), next(str), len(len) { operator++(); }
...
utf8::buffer_decoder_helper::buffer_decoder_helper(const char* str, int len) : str(str), len(len) {}
...
utf8::buffer_decoder_helper utf8::decoder(const char* str, int len) {
